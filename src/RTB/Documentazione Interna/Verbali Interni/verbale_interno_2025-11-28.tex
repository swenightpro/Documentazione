...
% -------------------------------------------------------------------
%  SEZIONE: todo (Attività da svolgere)
% -------------------------------------------------------------------
\newpage
...
Ogni attività ha come scadenza la fine dello sprint corrente, fissata per venerdì prossimo.
...
Studio preliminare del PoC & Progr./Progettista \\
Studio e bozza Piano di Qualifica & Amministratore \\
Implementare Gulpease e LanguageTool & Progr./Amministratore \\
...
% -------------------------------------------------------------------
%  SEZIONE: rotazione ruoli
% -------------------------------------------------------------------

\subsection{Definizione dei ruoli - Preventivo}
Sono stati definiti i ruoli e le relative assegnazioni orarie per il prossimo periodo operativo (Periodo 4), che coprirà l'arco temporale dal 29 Novembre al 05 Dicembre 2025.
La ripartizione è stata stabilita come segue:

\begin{itemize}
    \item \textbf{Responsabile:} Leonardo Bilato (3h)
    \item \textbf{Analista:} Michele Ogniben (3h), Francesco Zanella (1.5h)
    \item \textbf{Progettista:} Samuele Perozzo (3h)
    \item \textbf{Verificatore:} Francesco Zanella (2h), Giovanni Ponso (2h)
    \item \textbf{Programmatore:} Davide Biasuzzi (3h)
    \item \textbf{Amministratore:} Davide Biasuzzi (1h), Mihaela-Mariana Romascu (2h)
\end{itemize}
\end{document}