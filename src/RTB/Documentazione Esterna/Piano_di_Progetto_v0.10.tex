...
\end{figure}
    ...
    {\large Data: 2026-01-31 \par}
    {\Large Versione: 0.10 \par} 
...
\subsubsection*{Considerazioni finali (Sprint Review e Retrospective)}
Il preventivo del periodo è stato volutamente contenuto (37\,h) in considerazione della concomitanza con la sessione d'esami, che riduce la disponibilità oraria dei membri del gruppo. Il consuntivo (47\,h) risulta superiore al preventivo, in linea con le attività documentali e di implementazione effettivamente svolte.
