...
\graphicspath{{../../assets/}{../assets/}{assets/}{assets/UC_AnalisiRequisiti}{Contenuti/}{out/uc/}}
...
\begin{itemize}
    ...
    \item \textbf{Utente (Generico)}: Attore astratto che rappresenta qualsiasi entità loggata a sistema, raggruppando le operazioni comuni e trasversali (es. logout).
