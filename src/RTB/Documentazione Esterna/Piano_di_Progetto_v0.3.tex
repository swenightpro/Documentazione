...
\usepackage[table]{xcolor}       % Per i colori nelle tabelle
...
\begin{itemize}
    \item \href{https://swenightpro.github.io/Documentazione/docs/Candidatura/Documentazione\%20Interna/Norme_di_Progetto_v1.0.pdf}{Norme di Progetto v.1.0}
...
\begin{itemize}
    \item \href{https://swenightpro.github.io/Documentazione/docs/Candidatura/Documentazione%20Interna/Glossario_v1.0.pdf}{Glossario v.1}
...
\begin{table}[H]
\caption*{\textbf{Attività pianificate} (Sprint Backlog)}
\vspace{0.2cm}
\centering
\renewcommand{\arraystretch}{1.4}
...
\begin{table}[H]
\vspace{-0.2cm}
\caption*{\textbf{Riepilogo ore individuali}}
\vspace{0.2cm}
\centering
\renewcommand{\arraystretch}{1.4}
\rowcolors{2}{gray!10}{white}
...
\begin{table}[H]
\caption*{\textbf{Bilancio economico} (basato su \hyperref[sec:preventivo_v2]{Preventivo Costi - Seconda stesura})}
\vspace{0.3cm}
...
Verificatore (15€/h)  &                 133 & 1995    &             9 & 135    &               124 & 1860  \\
\hline
\rowcolor{blue!10} 
Totale                &                 630 &   12850 &            33 &   720  &               597 & 12130 \\
\hline
\end{tabular}
\end{table}
...
Verificatore (15€/h)  &                 124 & 1860    &             3 & 45    &               121 & 1815  \\
\hline
\rowcolor{blue!10} 
Totale                &                 597 & 12130   &            21 &   505 &               576 & 11625 \\
\hline
\end{tabular}
\end{table}
...
Programmatore (15€/h) &                 151 & 2265     &              0  & 0      &               151 & 2265  \\
Verificatore (15€/h)  &                 121 & 1815     &              4  & 60     &               117 & 1755  \\
\hline
\rowcolor{blue!10} 
Totale                &                 576 & 11625    &              23 & 550    &                604 & 11075 \\
\hline
\end{tabular}
\end{table}
...
%%%%%%%%%%%%%%%%%%%%% Valutazione e miglioramento  %%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Considerazioni finali (Sprint Review e Retrospective)}
Il gruppo ha ottemperato positivamente agli obiettivi del terzo periodo. Sebbene il monte ore consuntivato (23 ore) abbia superato quello preventivato (19 ore) — discrepanza che verrà mitigata in futuro tramite stime più conservative — l'efficienza operativa è stata eccellente. L'applicazione del workflow, caratterizzata da una definizione inequivocabile delle responsabilità e da flussi comunicativi asincroni, ha garantito un clima collaborativo proficuo e un avanzamento lavori trasparente.
\newpage
% ==================================================================
%  FINE PERIODO 3
% ==================================================================
