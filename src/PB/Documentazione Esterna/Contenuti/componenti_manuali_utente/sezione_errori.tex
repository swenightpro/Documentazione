...
\begin{longtable}{|p{4cm}|p{4cm}|p{5.5cm}|}
    ...
    \hline
    \textit{``Impossibile trascrivere l'audio''} & Audio troppo basso, rumore di fondo eccessivo o vocabolario non riconosciuto & Ripetere la frase in modo pi\`u chiaro, avvicinarsi al microfono, diminuire i rumori ambientali. In alternativa, digitare il testo. \\
    \hline
