...
\subsection{Area personale (Operatore)}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{Contenuti/immagini/area personale operatore.png}
        \includegraphics[width=0.4\textwidth]{Contenuti/immagini/cambio password operatore.png}
