...
% --- Grafica e Layout ---
\usepackage{graphicx}
\graphicspath{{Contenuti/}{Contenuti/specifiche_tecniche_assets/}{../../assets/}{../assets/}{assets/}}
...
\input{Contenuti/backend_l4_controllers}
\input{Contenuti/backend_l4_services}
\input{Contenuti/backend_l4_domain}
\input{Contenuti/backend_l4_ports}
\input{Contenuti/backend_l4_adapters}

\subsection{Frontend - C4 Livello 4}
La sottosezione presenta i componenti frontend identificati nel C4 Livello 4.

\input{Contenuti/frontend_l4_pages}
\input{Contenuti/frontend_l4_state}
\input{Contenuti/frontend_l4_services}
\input{Contenuti/frontend_l4_realtime}
\input{Contenuti/frontend_l4_ui}
