...
\usepackage{parskip}         % Spaziatura tra paragrafi, no indent

% ===================================================================
%  IMPOSTAZIONE GENERALE DOCUMENTO
% ===================================================================
\geometry{
    top=2.5cm,
    bottom=2.5cm,
...
\hypersetup{
    ...
    urlcolor=DarkBlue,
    citecolor=DarkBlue,
    pdftitle={Lettera di Presentazione - NightPRO},
...
\begin{titlepage}
    ...
    {\Large \textbf{Università degli Studi di Padova}}\\[0.3cm]
    {\small Corso di Laurea in Informatica (L-31)}\\[0.1cm]
    {\small Corso di Ingegneria del Software}\\[0.5cm]
    {\small \textit{Anno Accademico 2025/2026}}\\[2cm]

    {\Huge \bfseries Lettera di Presentazione}\\[1cm]
    {\Large \bfseries Gruppo: NightPRO}\\[0.4cm]
    {\large \href{mailto:swe.nightpro@gmail.com}{swe.nightpro@gmail.com}}\\[2cm]

    {\large \textbf{Data:} 28 ottobre 2025}\\[0.5cm]
...
\subsection{Dettagli del Documento}
\begin{itemize}
    \item \textbf{Data:} 28 ottobre 2025
    \item \textbf{Redatto da:} Francesco Zanella, Samuele Perozzo
    \item \textbf{Verificato da:} Tutti i membri del gruppo
    \item \textbf{Versione:} 1.0.0
\end{itemize}
...
Nel complesso, l’incontro si è rivelato estremamente chiaro e collaborativo: il dott. Gianluca Carlessa (rappresentante Ergon informatica) ha mostrato grande disponibilità, rispondendo con precisione a ogni quesito e fornendo indicazioni utili per orientare la progettazione.  
...
Come indicato nel documento \textit{Preventivo dei costi e degli impegni orari}, il costo stimato per la realizzazione del prodotto è pari a \textbf{12.600\,€}, con una previsione di consegna fissata al \textbf{21 marzo 2025}.
